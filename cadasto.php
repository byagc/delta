	...
	<div class=" box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="imagens/logo/logo-clara.png" alt="">
				</a>
			</div>
			<div class="">
				<ul>
					<li><a href="login.html"><font color="#ffffff">Voltar para o Início</font></a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="register-page-wrap d-flex align-items-center flex-wrap justify-content-center">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-md-4">
					<div class="register-box fundo-login box-shadow border-radius-10">
						<div class="wizard-content ">
							<form class="tab-wizard2 wizard-circle wizard">
								<h5><font color="#ffffff">Informação Pessoal</font></h5>
								<section>
								...
								<!-- Step 2 -->
								<h5><font color="#ffffff">Endereço Residencial</font></h5>
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
								...
								<!-- Step 3 -->
								<h5><font color="#ffffff">Payment Method & Info</font></h5>
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
								...
								<!-- Step 4 -->
								<h5><font color="#ffffff">Overview Information</font></h5>
								<section>
									<div class="form-wrap max-width-600 mx-auto">
		...
		<div class="modal-dialog modal-dialog-centered max-width-400" role="document">
			<div class="modal-content">
				<div class="modal-body text-center font-18">
					...
					<font color="#000000">Cadastro efetuado com êxito. Clique em "Página de Login" para ser redirecionado.</font>
				</div>
				<div class="modal-footer justify-content-center">
					<a href="login.php" class="btn btn-primary">Página de Login</a>
				</div>
			</div>
		</div>
	</div>
